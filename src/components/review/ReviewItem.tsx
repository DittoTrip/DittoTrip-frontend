...
const ReviewItem = ({ review, setIsExpandedOption }: Props) => {
  ...
  console.log(review.imagePaths);

  return (
    <ReviewItemStyle>
      <UserProfileWithComment
        name={review.userData.userName}
        date={review.createdDateTime.toLocaleString()}
      ...
      <div className="review-info">
        <div className="count">
          <FontAwesomeIcon className="icon" icon={review.myLike ? Thumb : empyThumb} onClick={() => {}} />
          <div className="count-text"> {review.likes}</div>
        </div>
        <div className="count">
